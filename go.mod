module github.com/ahmetson/sample-extension
...
require (
	github.com/ahmetson/common-lib v0.0.0-20230718165353-3ede3bc77099
	github.com/ahmetson/service-lib v0.0.0-20230724122944-3c959d10eb41
)
